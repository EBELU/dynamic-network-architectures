...
class UNetResDecoder(nn.Module):
    def __init__(self,
        ...
        self.use_attention = attention_gate
    ...
    def forward(self, skips):
        ...
        for s in range(len(self.stages)):
            ...
            x_skip = skips[-(s + 2)]
            if s > 0 and self.use_attention:
                x_skip = self.attention_gates[s - 1](x_skip, x)
...
class UNetResAttentionDecoder(nn.Module):
    def __init__(self,
                 encoder: Union[PlainConvEncoder, ResidualEncoder],
                 num_classes: int,
                 n_conv_per_stage: Union[int, Tuple[int, ...], List[int]],
