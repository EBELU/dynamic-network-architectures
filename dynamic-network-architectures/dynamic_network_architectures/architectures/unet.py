...
class ResidualEncoderAttentionUNet(AbstractDynamicNetworkArchitectures):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
...
class ResidualUNet_SqueezeAttention(nn.Module):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
...
class ResidualUNet_SqueezeGatedAttention(nn.Module):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
        ...
        self.decoder = UNetResDecoder(self.encoder, num_classes, n_conv_per_stage_decoder, deep_supervision, attention_gate=True)
...
class ResidualUNet_CBAMAttention(nn.Module):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
        ...
        print("Running Residual Encode + Decoder")
        self.encoder = ResidualEncoder(
            input_channels,
            n_stages,
            features_per_stage,
...
class ResidualUNet_CBAMGatedAttention(ResidualUNet_CBAMAttention):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
