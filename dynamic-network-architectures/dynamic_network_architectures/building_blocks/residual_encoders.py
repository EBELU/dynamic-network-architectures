...
class ResidualEncoder(nn.Module):
    def __init__(self,
        ...
        for s in range(n_stages):
            ...
            is_bottleneck_stage = False
            if s == n_stages - 1 and bottleneck_modification == "context":
                is_bottleneck_stage = True
            ...
            stage = StackedResidualBlocks(
                ...
                squeeze_excitation_reduction_ratio=squeeze_excitation_reduction_ratio, cbam=cbam, is_bottleneck_stage=is_bottleneck_stage
            )
